...
class MainMenu(Scene):
    ...
    def setup(self):
        ...
        quit_btn = Button(name="quit", x=x, y=y+btn_h+30, width=btn_w, height=btn_h, bg_color=(200,70,70), text="Quit", text_color=(0,0,0), on_click="QUIT", hover_bg_color=(230,100,100))
