...
class WinScene(Scene):
    ...
    def setup(self):
        title = Widget(name="title", x=0, y=40, width=self.screen_width, height=80, bg_color=(20,120,20), text="You Win!", text_color=(255,255,255))
        ...
        menu = Button(name="menu", x=(self.screen_width-200)//2, y=250, width=200, height=50, bg_color=(70,200,120), text="Main Menu", text_color=(0,0,0), on_click="MainMenu", hover_bg_color=(100,230,150))
